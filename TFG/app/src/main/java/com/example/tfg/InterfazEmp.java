...
public class InterfazEmp extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.interfaz_empleado);
        ...
        MenuEmpleado menuFragment = new MenuEmpleado();
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MessageEmp messageFragment = new MessageEmp();
                Bundle args = new Bundle();
                args.putSerializable("user", user);
                args.putString("nombre", nom);
